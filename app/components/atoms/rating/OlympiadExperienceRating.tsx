...
interface OlympiadExperienceRatingProps {
    Color: string;
    ActiveDots: number;
    ClassName?: string;
};
...
function OlympiadExperienceRating(Props: OlympiadExperienceRatingProps) {
    return (
        <div className={clsx("flex flex-row justify-between h-auto gap-x-3", Props.ClassName)}>
            ...
            {Array.from({ length: 4 - Props.ActiveDots }, (_, Index) => Index + 1).map((DotIndex) => (
...
export default OlympiadExperienceRating;