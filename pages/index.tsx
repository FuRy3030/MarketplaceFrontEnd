...
function LandingPage({ UniversityNames } : { UniversityNames: string [] }) {
    ...
    return (
        <>
            ...
            <div className='flex flex-col md:flex-row justify-between items-center md:mb-32'>
                <div className='w-full md:w-[45%] mt-6 mx-auto max-w-[600px] px-7 md:px-10'>
                    <h1 className='text-3xl font-bold text-brand-purple-light mb-1 cursor-default'>
                        Chcesz dostać się na prestiżową uczelnię?
                    </h1>
                    <h3 className='text-xl font-bold text-dark mb-2 cursor-default'>
                        Spełnimy twoje marzenie przygotowując Cię do wybranej olimpiady przedmiotowej!
                    </h3>
                    <h6 className='text-sm font-bold text-semi-dark mb-3 cursor-default'>
                        Nasi tutorzy z pewnością nie mogą doczekać się żeby cię poznać!
                    </h6>
                    <OlympiadsSearchForm 
            ...
            <div className='relative w-full h-auto'>
                <div className='z-10 absolute top-[20px] w-[94vw] items-start pl-2.5 mx-auto h-auto flex flex-col md:left-[7.5vw] md:w-[70vw] md:items-start md:px-0'>
                    ...
                    <div className='p-4 bg-white-transparent-90 rounded-xl mb-5'>
                        <p className='text-sm text-dark font-semibold cursor-default text-justify md:text-lg'>
                    ...
                    <StandardButton Text={"Przygotuj się razem z nami!"} onClick={() => Router.push('/tutors')} ClassNames={'w-max'}
